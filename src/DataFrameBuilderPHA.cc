...
void DataFrameBuilderPHA::ProduceTimeStamp( ){
    ...
    if( fDgtzName.find("730") != std::string::npos ||
        ...
        this->fTimeStamp = 2;
             ...
             fDgtzName.find("780") != std::string::npos ){
        this->fTimeStamp = 10;
    }
}
...
void DataFrameBuilderPHA::ProduceFlags( ){
    ...
    if( fDgtzName.find("780") != std::string::npos ){
...
void DataFrameBuilderPHA::ProduceFormats( ){
    ...
    else if( fDgtzName.find("780") != std::string::npos ){
